...
#^ Armorstand summon
#v Mob summon
execute at @s run summon husk ~ ~ ~ {Tags:["<project:name>.base","given","new"],NoGravity:0b,Silent:1,NoAI:0b,Invulnerable:0b,ActiveEffects:[{Id:14,Amplifier:0,Duration:999999,ShowParticles:1b,PersistenceRequired:1b}]}
#map this to any animation pose
execute at @e[tag=<project:name>.base,tag=new] run function <project:name>:summon/pose
...
### Or add <project:name>:aimob/aimobloop to your tick.json
