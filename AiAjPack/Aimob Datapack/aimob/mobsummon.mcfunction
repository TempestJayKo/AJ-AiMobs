...
### vvv if you wish to summon multiple zombies disable this function / Will teleport mob to void and run the remove command
...
#add linked tag
tag @e[tag=new,tag=<project.name>.base] add linked
